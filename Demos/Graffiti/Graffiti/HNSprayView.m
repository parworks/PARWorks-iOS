...
- (void)revealWithRevealType:(SprayViewRevealType)type
{
    ...
    [_revealTimer invalidate];
    _revealTimer = [NSTimer scheduledTimerWithTimeInterval:0.005 target:self selector:@selector(updateStamp) userInfo:nil repeats:YES];
