...
#define kHNBrushPickerFolderViewDefaultsSliderKey @"kHNBrushPickerFolderViewDefaultsSliderKey"
#define kHNBrushPickerFolderViewDefaultsBrushName @"kHNBrushPickerFolderViewDefaultsBrushName"

@implementation HNBrushPickerFolderView
...
{
    [[NSUserDefaults standardUserDefaults] setFloat:_brushSizeSlider.value forKey:kHNBrushPickerFolderViewDefaultsSliderKey];
}

- (float)brushSizeFromDefaults
{
    float value = [[NSUserDefaults standardUserDefaults] floatForKey:kHNBrushPickerFolderViewDefaultsSliderKey];
    if (value == 0) {
        value = 20;
    }
    return value;
...
{
    NSString *name = [[NSUserDefaults standardUserDefaults] objectForKey:kHNBrushPickerFolderViewDefaultsBrushName];
    if (!name) {
        name = _brushNames[0];
    }
    return name;
...
{
    [[NSUserDefaults standardUserDefaults] setObject:_currentBrushName forKey:kHNBrushPickerFolderViewDefaultsBrushName];
}
