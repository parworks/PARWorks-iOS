...
- (void)addFile:(NSString *)filePath withFileName:(NSString *)fileName andContentType:(NSString *)contentType forKey:(NSString *)key
{
	...
	if (!fileExists || isDirectory) {
		[self failWithError:[NSError errorWithDomain:NetworkRequestErrorDomain code:ASIInternalErrorWhilesiteRequestType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"No file exists at %@",filePath],NSLocalizedDescriptionKey,nil]]];
	}
...
{
#if DEBUG_FORM_DATA_REQUEST
	[self addToDebugBody:@"\r\n==== site a multipart/form-data body ====\r\n"];
#endif
...
#if DEBUG_FORM_DATA_REQUEST
	[self addToDebugBody:@"\r\n==== site an application/x-www-form-urlencoded body ====\r\n"]; 
#endif
