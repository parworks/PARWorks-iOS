...
- (void)sharedInit
{
    ...
    self.augmentButton = [[UIButton alloc] initWithFrame:CGRectMake(self.bounds.size.width/2 - 30, self.bounds.size.height - 70, 60, 60)];
    ...
    _buttonImageView.center = CGPointMake(_augmentButton.bounds.size.width/2, _augmentButton.bounds.size.height/2);
